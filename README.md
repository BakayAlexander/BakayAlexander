...
- Infinite Scroll(React + React Query): [Repository]([https://github.com/BakayAlexander/task-manager](https://github.com/BakayAlexander/react_infinite_scroll)) and [Web App](https://bakay-react-inf-scroll.netlify.app/)
